...
///////////////////////////////////////////////////////////////////////////////////
  final public List < Resource > document() throws ParseException {List < Resource > resourceList;
    jj_consume_token(GRAPHS);
    resourceList = arrayGraph();
return resourceList;
}

  final public List < Resource > arrayGraph() throws ParseException {List < Resource > resourceList = new ArrayList < Resource >();
  Resource r;
