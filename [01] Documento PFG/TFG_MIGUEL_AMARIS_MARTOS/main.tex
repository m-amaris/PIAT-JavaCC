...
% CONFIGURACION DE LA BIBLIOGRAFIA
...
\title{Análisis y procesamiento de información textual utilizando generadores de compiladores}\author{Miguel Amarís Martos}
...
% BIBLIOGRAFIA (NO REFERENCIADA DIRECTAMENTE)
