...
public class Parser implements ParserConstants {
  ...
  final public void procesarLinea(ConcurrentHashMap<String, String> hmServidores,ConcurrentHashMap <String,AtomicInteger> hmUsuarios) throws ParseException {Token fecha,hora,tipoServidor,numeroServidor;
