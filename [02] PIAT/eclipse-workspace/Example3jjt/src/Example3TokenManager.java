/* Example3TokenManager.java */
/* Generated By:JJTree&JavaCC: Do not edit this line. Example3TokenManager.java */

/** Token Manager. */
public class Example3TokenManager implements Example3Constants {
...
static private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public Example3TokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public Example3TokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
