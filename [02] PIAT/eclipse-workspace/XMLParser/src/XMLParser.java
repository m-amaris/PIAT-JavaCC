...
public class XMLParser/*@bgen(jjtree)*/implements XMLParserTreeConstants, XMLParserConstants {/*@bgen(jjtree)*/
  protected static JJTXMLParserState jjtree = new JJTXMLParserState();public static void main(String [] args) throws ParseException
  {
    XMLParser parser;
            try
    {
  ...
  static final public void document() throws ParseException {/*@bgen(jjtree) document */
...
if (jjtc000) {
  ...
  static final public void concepts() throws ParseException {/*@bgen(jjtree) concepts */
...
if (jjtc000) {
  ...
  static final public void concept() throws ParseException {/*@bgen(jjtree) concept */
...
if (jjtc000) {
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x1000,0x40,0x280,0x1000,0x800,0x800,0x280,};
	}
