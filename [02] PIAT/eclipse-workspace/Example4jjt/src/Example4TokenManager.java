/* Example4TokenManager.java */
/* Generated By:JJTree&JavaCC: Do not edit this line. Example4TokenManager.java */

/** Token Manager. */
public class Example4TokenManager implements Example4Constants {
...
static private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public Example4TokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public Example4TokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
