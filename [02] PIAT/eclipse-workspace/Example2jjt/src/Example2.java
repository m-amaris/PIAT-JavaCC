/* Example2.java */
/* Generated By:JJTree&JavaCC: Do not edit this line. Example2.java */
/**
 * An Arithmetic Grammar.
 */
public class Example2/*@bgen(jjtree)*/implements Example2TreeConstants, Example2Constants {/*@bgen(jjtree)*/
  protected static JJTExample2State jjtree = new JJTExample2State();
  /** Main entry point. */
...
if (jjtc000) {
  ...
  static public Example2TokenManager token_source;
  ...
  public Example2(java.io.InputStream stream) {
	  this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public Example2(java.io.InputStream stream, String encoding) {
	 ...
	 token_source = new Example2TokenManager(jj_input_stream);
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
  ...
  /** Constructor. */
  public Example2(java.io.Reader stream) {
	 if (jj_initialized_once) {
	   System.out.println("ERROR: Second call to constructor of static parser. ");
	   System.out.println("	   You must either use ReInit() or set the JavaCC option STATIC to false");
	   System.out.println("	   during parser generation.");
 ...
 token_source = new Example2TokenManager(jj_input_stream);
  ...
  public Example2(Example2TokenManager tm) {
	 if (jj_initialized_once) {
	   System.out.println("ERROR: Second call to constructor of static parser. ");
	   System.out.println("	   You must either use ReInit() or set the JavaCC option STATIC to false");
	   System.out.println("	   during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(Example2TokenManager tm) {
	 token_source = tm;
	 token = new Token();
	 jj_ntk = -1;
	 jjtree.reset();
