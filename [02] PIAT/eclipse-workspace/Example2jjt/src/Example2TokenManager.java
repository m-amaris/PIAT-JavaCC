/* Example2TokenManager.java */
/* Generated By:JJTree&JavaCC: Do not edit this line. Example2TokenManager.java */

/** Token Manager. */
public class Example2TokenManager implements Example2Constants {
...
static private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public Example2TokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public Example2TokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
