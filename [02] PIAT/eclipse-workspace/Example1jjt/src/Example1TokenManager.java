/* Example1TokenManager.java */
/* Generated By:JJTree&JavaCC: Do not edit this line. Example1TokenManager.java */

/** Token Manager. */
public class Example1TokenManager implements Example1Constants {
...
static private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public Example1TokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public Example1TokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
